...
@ComponentScan(basePackages = {"kz.cf.spring.lesson3"})
@EnableJpaRepositories(basePackages = {"kz.cf.spring.lesson3.repos"})
...
public class EnversConfig {
	...
	public EntityManagerFactory entityManagerFactory() {
		...
		factoryBean.setPackagesToScan("kz.cf.spring.lesson3.entities");
