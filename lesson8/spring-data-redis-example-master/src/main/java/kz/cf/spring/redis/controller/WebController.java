package kz.cf.spring.redis.controller;
...
import kz.cf.spring.redis.repository.RedisRepository;
...
public class WebController {
    ...
    public ResponseEntity<String> add(
        ...
        MyMessage myMessage = new MyMessage(key, value);
        
        redisRepository.add(myMessage);
