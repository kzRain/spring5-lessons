package kz.cf.spring5.lesson2.dao;
	...
	public List<Singer> findAll() {
		...
		try {
			...
			PreparedStatement statement =
					connection.prepareStatement("select * from public.singer");
	...
	public void insert(Singer singer) {
		...
		try {
			...
			PreparedStatement statement = connection.prepareStatement(
					"insert into public.singer (first_name, last_name, birth_date) values (?, ?, ?)"
